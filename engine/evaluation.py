...
>>>>>>> 073694a ( added to my evaluation function to enable alpha beta prunning. Although currently running into a bug that engine tries to make illegal moves/some other glitch)
